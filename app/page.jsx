...
export default function Home() {
 ...
 <section className="py-20">
  <div className="container mx-auto px-4"> 
    <h2 className="text-3xl font-bold text-center mb-12">All the tools you need to take control of your finances.</h2>
 ...
 <section className="py-20 bg-blue-50">
  <div className="container mx-auto px-4"> 
    <h2 className="text-3xl font-bold text-center mb-12">How It operates</h2>
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      {howItWorksData.map((step, index) => (
       <div key={index} className="text-center">
        <div className="w-16 h-15 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-6">{step.icon}</div>
 ...
 <section className="py-20">
  <div className="container mx-auto px-4"> 
    <h2 className="text-3xl font-bold text-center mb-12">Feedback from Our Users</h2>
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
